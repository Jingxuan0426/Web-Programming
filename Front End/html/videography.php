  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="/Front End/images/Videography/e53.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Videography</h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="/Front End/images/Videography/e54.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Videography</h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="/Front End/images/Videography/e55.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Videography</h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="/Front End/images/Videography/e56.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Videography</h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="/Front End/images/Videography/e57.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Videography</h1>
        </div>
      </div>
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card">
            ...
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="/Front End/html/project_videography.html" target="_blank"><button type="button" class="btn-view mx-auto">Seasons</button></a>
              </h2>
            </div>
          </div>
        </div>
