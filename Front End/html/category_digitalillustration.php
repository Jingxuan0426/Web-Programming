  ...
  <body style="background-color: black;">
    ...
    <div id="carouselExampleCaptions" class="carousel slide"
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/Front End/images/2D Illustration/harted_project/2dill_cover.jpg"
    ...
    <div class="container">
      ...
      <div class="card"
        ...
        <a href="/Front End/html/category_2dillustration.php">
      ...
      <div class="card"
        style="border: 3px solid #a10d3c; background-color: black;">
        <a href="/Front End/html/category_3dillustration.php">
