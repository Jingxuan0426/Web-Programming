  ...
  <section id="category">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card">
            ...
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="" target="_blank"><button type="button" class="btn-view mx-auto">Astrophotography</button></a>
              </h2>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card">
            ...
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="" target="_blank"><button type="button" class="btn-view mx-auto">Spices</button></a>
              </h2>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card">
            ...
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="" target="_blank"><button type="button" class="btn-view mx-auto">The Street Photography Guide</button></a>
              </h2>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card">
            <img src="/Front End/images/Photography/e34.jpg" class="card-img" alt="...">
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="" target="_blank"><button type="button" class="btn-view mx-auto">Cityscapes</button></a>
              </h2>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card">
            <img src="/Front End/images/Photography/e35.jpg" class="card-img" alt="...">
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="" target="_blank"><button type="button" class="btn-view mx-auto">Breakfast Pastries</button></a>
              </h2>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card">
            <img src="/Front End/images/Photography/e36.jpg" class="card-img" alt="...">
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="" target="_blank"><button type="button" class="btn-view mx-auto">Street Photography in India</button></a>
              </h2>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card">
            <img src="/Front End/images/Photography/e37.jpg" class="card-img" alt="...">
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="" target="_blank"><button type="button" class="btn-view mx-auto">The Nature Photography Contest</button></a>
              </h2>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card" style="margin-bottom: 5rem;">
            <img src="/Front End/images/Photography/e38.jpg" class="card-img" alt="...">
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="" target="_blank"><button type="button" class="btn-view mx-auto">Creative Tricks</button></a>
              </h2>
            </div>
          </div>
        </div>
