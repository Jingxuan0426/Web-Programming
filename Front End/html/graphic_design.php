  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="/Front End/images/Graphic Design/e10.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Graphic Design</h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="/Front End/images/Graphic Design/e11.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Graphic Design</h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="/Front End/images/Graphic Design/e12.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Graphic Design</h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="/Front End/images/Graphic Design/e13.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Graphic Design</h1>
        </div>
      </div>
      <div class="carousel-item">
        <img src="/Front End/images/Graphic Design/e14.jpg" class="d-block w-100 col-12" alt="...">
        <div class="carousel-caption justify-content-center d-flex">
          <h1 class="d-block" style="font-size: 5rem; margin-bottom: 285px;">Graphic Design</h1>
        </div>
      </div>
        ...
        <div class="col-md-4 py-3 py-md-0 col-12">
          <div class="card" style="margin-bottom: 5rem;">
            ...
            <div class="card-img-overlay">
              <h1 class="card-title"></h1>
              <h2 class="card-body text-center">
                <a href="/Front End/html/project_graphicdesign.html" target="_blank"><button type="button" class="btn-view mx-auto">Detroit Design</button></a>
              </h2>
            </div>
          </div>
        </div>
